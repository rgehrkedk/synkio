...
(() => {
  ...
  function normalizeToken(obj, path = "") {
    var _a, _b, _c;
  ...
  function inferTypeFromPath(path) {
    ...
    if (lowerPath.includes("color") || lowerPath.includes("background") || lowerPath.includes("foreground") || lowerPath.includes("border") || lowerPath.includes("fill") || lowerPath.includes("stroke")) {
      return "color";
    }
    if (lowerPath.includes("radius")) return "dimension";
    if (lowerPath.includes("shadow")) return "shadow";
    if (lowerPath.includes("spacing") || lowerPath.includes("gap") || lowerPath.includes("padding") || lowerPath.includes("margin")) {
      return "dimension";
    }
    return "string";
  }
