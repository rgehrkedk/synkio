...
export async function initCommand(options: InitOptions = {}) {
    ...
    if (!figmaToken) {
        ...
        console.log('2. Open the Figma plugin and click "Sync to Node"');
        console.log('3. Copy the node ID and paste it into tokensrc.json');
        console.log('4. Run: synkio validate');
        console.log('5. Run: synkio sync');
    } else {
        console.log('1. Open the Figma plugin and click "Sync to Node"');
        console.log('2. Copy the node ID and paste it into tokensrc.json');
        console.log('3. Run: synkio sync');
    }
}
